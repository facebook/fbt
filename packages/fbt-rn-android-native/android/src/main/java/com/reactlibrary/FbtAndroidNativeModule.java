...
public class FbtAndroidNativeModule extends ReactContextBaseJavaModule {

  public static final String NAME = "FbtAndroidNativeModule";
  ...
  public FbtAndroidNativeModule(ReactApplicationContext context) {
    super(context);
