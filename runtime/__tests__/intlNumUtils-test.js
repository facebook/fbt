...
describe('intNumUtils.formatNumberWithThousandDelimiters', function() {
  ...
  it('Should round (not truncate) decimals', function() {
    expect(u.formatNumberWithThousandDelimiters(1234.5655, 2)).toBe('1,234.57');
    expect(u.formatNumberWithThousandDelimiters(1234.5644, 2)).toBe('1,234.56');
  ...
  it('Should handle a higher precision than given', function() {
    expect(u.formatNumberWithThousandDelimiters(1234.1, 5)).toBe('1,234.10000');
  });
  ...
  it('Should respect primary and secondary grouping sizes in Hindi', function() {
    ...
    expect(u.formatNumberWithThousandDelimiters(1234567.1)).toBe('12,34,567.1');
    jest.resetModules();
  });
  ...
  it('Should respect user locale for number formatting', function() {
    ...
    // Above the thousand separator threshold.
    expect(u.formatNumberWithThousandDelimiters(123456.1, 1)).toBe('123/456#1');
